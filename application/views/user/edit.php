    ...
    <div class="col-5">
        <div class="card">
            ...
            <form role="form" method="POST" action="" autocomplete="off">
                <input type="hidden" name="fid_user" value="<?= $user->id_user ?>">
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('ftelepon') ? 'is-invalid' : '' ?>" id="ftelepon" name="ftelepon" placeholder="Enter Telepon" value="<?= $user->telepon ?>">
                        <div class="invalid-feedback">
                            <?= form_error('ftelepon') ?>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="falamat" id="falamat" class="form-control <?= form_error('falamat') ? 'is-invalid' : '' ?>" cols="10" rows="5" placeholder="Enter Alamat"><?= $user->alamat ?></textarea>
                        <div class="invalid-feedback">
                            <?= form_error('falamat') ?>
                        </div>
                    </div>
