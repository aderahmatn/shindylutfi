            ...
            <form role="form" method="POST" action="" autocomplete="off" enctype="multipart/form-data">
                <div class="card-body">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control <?= form_error('fnama_kategori') ? 'is-invalid' : '' ?>" id="fnama_kategori" name="fnama_kategori" placeholder="Enter Kategori" value="<?= $this->input->post('fnama_kategori'); ?>">
