    ...
    <div class="row">
        ...
        <div class="col-md-4 bg-form-order">
            ...
            <form role="form" method="POST" action="" autocomplete="off">
                ...
                <div class="form-group">
                    <input type="password" class="form-control <?= form_error('fconfrim_password') ? 'is-invalid' : '' ?>" id="fconfrim_password" name="fconfrim_password" placeholder="Ulangi Password" value="<?= $this->input->post('fconfrim_password'); ?>">
                    <div class="invalid-feedback">
                        <?= form_error('fconfrim_password') ?>
                    </div>
                </div>
                <div class="form-group">
                    <textarea name="falamat" id="falamat" class="form-control <?= form_error('falamat') ? 'is-invalid' : '' ?>" placeholder="Alamat"><?= $this->input->post('falamat'); ?></textarea>
                    <div class="invalid-feedback">
                        <?= form_error('fconfrim_password') ?>
                    </div>
                </div>
