...
<head>
    ...
    <title>ShindyLutfi | Administrator Login</title>
...
<body class="hold-transition login-page bg-nude">
    <div class="login-box">
        <div class="row  justify-content-center">

            <!-- <img src="<?= base_url() . 'assets/images/icon.png' ?>" alt="AdminLTE Logo" class="brand-image " style="width: 120;"> -->
        </div>
        <div class="login-logo">
            <img src="<?= base_url() . 'assets/images/icon.png' ?>" alt="Logo" class="brand-image " style="width: 30px;">
            <a href="index2.html">admin <b>ShindyLutfi</b></a>
        </div>
        <!-- /.login-logo -->
        <div class="card">
            <div class="card-body login-card-body">
                ...
                <form action="<?= base_url('auth/process_login_admin') ?>" method="post" autocomplete="off">
                    ...
                    <button type="submit" class="btn btn-warning btn-block" name="login">Log In</button>
            </div>
            </form>
