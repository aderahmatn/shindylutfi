                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control <?php echo form_error('fkategori') ? 'is-invalid' : '' ?>" id="fkategori" name="fkategori">
                            ...
                            <option value="pernikahan" <?= $this->input->post('fkategori') == "pernikahan" ? 'selected' : '' ?>>Pernikahan</option>
                            <option value="wisuda" <?= $this->input->post('fkategori') == "wisuda" ? 'selected' : '' ?>>Wisuda</option>
                        </select>
                        <div class="invalid-feedback">
                            <?= form_error('flevel') ?>
                        </div>
